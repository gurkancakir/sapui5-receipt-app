			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Receipt-display": {
								"semanticObject": "Receipt",
								"action": "display",
								"description": "Receipt App",
								"title": "Receipt",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gurkan.receipt-app",
									"url": sap.ui.require.toUrl("com/gurkan/receipt-app")
								}
							}
						}
					}
